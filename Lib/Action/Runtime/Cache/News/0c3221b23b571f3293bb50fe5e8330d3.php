...
try { ace.settings.check('breadcrumbs', 'fixed') } catch (e) { }
		...
		<ul class="breadcrumb">
			...
			<a target="_blank" href="http://dq/index.php?m=News&c=Index&a=uploadNews">增加新闻</a>
			</li>
						...
						<div class="widget-main no-padding">
							<table class="table table-bordered table-striped">
								...
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
									...
									<td><a target='_blank' href='http://dq/index.php?m=News&c=Index&a=change&id=<?php echo ($vo["id"]); ?>'>修改</a></td>
									<td><a target='_blank' href='http://dq/index.php?m=News&c=Index&a=pc&id=<?php echo ($vo["id"]); ?>'>pc预览</a></td>
									<td><a target='_blank' href='http://dq/index.php?m=News&c=Index&a=phone&id=<?php echo ($vo["id"]); ?>'>手机预览</a></td>
									<td><a target='_self' href='http://dq/index.php?m=News&c=Index&a=create&id=<?php echo ($vo["id"]); ?>'>生成页面</a></td>
									<td><a target='_self' href='http://dq/index.php?m=News&c=Index&a=del&id=<?php echo ($vo["id"]); ?>'>下线</a></td>
