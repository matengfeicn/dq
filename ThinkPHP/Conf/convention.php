...
return  array(
    ...
    'APP_GROUP_LIST'        => 'Article,News,Ueditor,Block,Home,Item,Template',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    ...
    /*
    'DB_TYPE'               => 'mysql',     // 数据库类型
    'DB_HOST'               => 'bdm108519173.my3w.com', // 服务器地址
    'DB_NAME'               => 'bdm108519173_db',          // 数据库名
    'DB_USER'               => 'bdm108519173',      // 用户名
    'DB_PWD'                => 'bdm108519173dq',          // 密码
     */
    'DB_PORT'               => '',        // 端口
    'DB_PREFIX'             => '',    // 数据库表前缀
