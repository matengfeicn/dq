...
<script src="__JS__jquery_1.js"></script>
    <script type="text/javascript" charset="utf-8" src="__JS__ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="__JS__ueditor/ueditor.all.js"></script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8" src="__JS__ueditor/lang/zh-cn/zh-cn.js"></script>
				...
				生成后台
                    ...
                    <div class="row">
                        <div class="col-xs-12">
							...
							<form name="form1" action="__ITEM__&a=uploadItem&channelid=<?php echo ($channelid); ?>" method="post" enctype="multipart/form-data">
								    ...
								    <tr id="table_tr">
									    ...
									    <td>
										    ...
										    | <a target="_blank" href="__ITEM__&a=addTable">新增表格</a> | <a  href="javascript:delTable()">删除表格</a>
									    </td>
								    </tr>
								    <?php if(is_array($table_info)): foreach($table_info as $key=>$vo): ?><tr class='new_tr'><td><?php echo ($vo); ?></td><td><input name='item[<?php echo ($key); ?>]'/></td></tr><?php endforeach; endif; ?>
...
dataType:"json",
url:"__ITEM__&a=delTable&jsonpcallback=?",
type:"get",
...
data:{"table_item_id":option},
dataType:"json",
url:"__ITEM__&a=getTableItem&jsonpcallback=?",
type:"get",
success:function(data){
$(".new_tr").remove();
