...
try { ace.settings.check('breadcrumbs', 'fixed') } catch (e) { }
		...
		<ul class="breadcrumb">
			...
			<a target="_blank" href="__ITEM__&a=uploadItem&channelid=<?php echo ($channelid); ?>">增加新产品</a>
			</li>
		</ul><!-- .breadcrumb -->
						...
						<div class="widget-main no-padding">
							<table class="table table-bordered table-striped">
								...
								<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
									...
									<td><a target='_blank' href='__ITEM__&a=change&id=<?php echo ($vo["id"]); ?>'>修改</a></td>
									<td><a target='_blank' href='__TEMPLATE__&a=pc&id=<?php echo ($vo["id"]); ?>'>pc预览</a></td>
									<td><a target='_blank' href='__TEMPLATE__&a=phone&id=<?php echo ($vo["id"]); ?>'>手机预览</a></td>
									<td><a target='_self' href='__TEMPLATE__&a=create&id=<?php echo ($vo["id"]); ?>'>生成页面</a></td>
									<td><a target='_self' href='__ITEM__&a=del&id=<?php echo ($vo["id"]); ?>'>下线</a></td>
									<td><a target='_self' href='__ITEM__&a=delR&id=<?php echo ($vo["id"]); ?>'>删除</a></td>
