...
<link rel="stylesheet" href="__PUBLIC__assets/css/ace.min.css" />
				...
				<div class="login-container">
					<div class="center">
						<h1>
							...
							<span class="white">新闻采集系统</span>
						</h1>
						<h4 class="blue">大公报-大公网</h4>
					</div>
						...
						<div id="login-box" class="login-box visible widget-box no-border">
							<div class="widget-body">
								<div class="widget-main">
									...
									<form action="__ADMIN__&a=login" method="post" name="form1">
										<fieldset>
											...
											<div class="clearfix">
												<!--
														<label class="inline">
															...
															<span class="lbl">记住登陆状态</span>
														</label>
														-->

												<button type="button" onclick="form1.submit()" class="width-35 pull-right btn btn-sm btn-primary">
													<i class="icon-key"></i>
													登陆
												</button>
											</div>
