		...
		<div class="navbar-header pull-right" role="navigation">
			<ul class="nav ace-nav">
				...
				<a data-toggle="dropdown" href="#" class="dropdown-toggle">
					<img class="nav-user-photo" src="__PUBLIC__assets/avatars/user.jpg" alt="Jason's Photo" />
...
try { ace.settings.check('sidebar', 'fixed') } catch (e) { }
			...
			<div class="sidebar-shortcuts" id="sidebar-shortcuts">
				<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
					<button class="btn btn-success" onclick="javascript:window.location.href='__ADMIN__&a=getChannel'">
						<i class="icon-signal"></i>
					</button>

					<!--
					<button class="btn btn-info" onclick="javascript:window.location.href='__INDEX__getChannel'">
						<i class="icon-pencil"></i>
					</button>
					-->

					<button class="btn btn-warning"  onclick="javascript:window.location.href='__INDEX__&a=create_mobile_homePage'">
...
function jump(param){
	switch (param){
		case 1:
			$("#iframe_main").attr("src","__INDEX__&a=homePage");
			break;
		case 2:
			$("#iframe_main").attr("src","__ITEM__&a=homePage");
			break;
		case 3:	
			$("#iframe_main").attr("src","__ITEM__&a=liquor_list");
			break;
		case 4:
			$("#iframe_main").attr("src","__INDEX__&a=homePage");
			break;
		case 5:
			$("#iframe_main").attr("src","__ADMIN__&a=changePwd");
			break;
		case 11:
			$("#iframe_main").attr("src","__ADMIN__&a=insertChannel");
			break;
		default:
