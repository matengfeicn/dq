...
try { ace.settings.check('breadcrumbs', 'fixed') } catch (e) { }
		...
		<ul class="breadcrumb">
			...
			<a target="_blank" href="javascript:;" onclick="__ADMIN__&addChannel">增加新频道</a>
			</li>
				...
				<div class="widget-box transparent">
					<div class="widget-body">
						<div class="widget-main no-padding">
							...
							<form action="__ADMIN__&a=addChannel&channelid=<?php echo ($channelid); ?>" method="post">
