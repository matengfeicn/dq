...
try { ace.settings.check('breadcrumbs', 'fixed') } catch (e) { }
		...
		<ul class="breadcrumb">
			...
			<a target="_blank" href="__ADMIN__&a=addChannel">增加新频道</a>
			</li>
						...
						<div class="widget-main no-padding">
							...
							<table class="table table-bordered table-striped">
								...
								<?php if(is_array($channel)): foreach($channel as $key=>$vo): ?><tr>
									...
									<td>
										<?php if($vo["type"] == '1'): ?>货物频道
										<?php else: ?>普通频道<?php endif; ?>
									</td>
									<td><a target="_blank" href="__ADMIN__&a=detailChannel&channelid=<?php echo ($vo["id"]); ?>">查看子结点</a>  |  <a target="_blank" href="__ADMIN__&a=delChannel&channelid=<?php echo ($vo["id"]); ?>">删除</a></td>
