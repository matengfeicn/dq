...
try { ace.settings.check('breadcrumbs', 'fixed') } catch (e) { }
		...
		<ul class="breadcrumb">
			...
			<a target="_blank" href="__ADMIN__&a=addChannel&channelid=<?php echo ($channelid); ?>">增加新频道</a>
			</li>
						...
						<div class="widget-main no-padding">
							...
							<table class="table table-bordered table-striped">
								...
								<?php if(is_array($channel)): foreach($channel as $key=>$vo): ?><tr>
									...
									<td><a target="_blank" href="__ADMIN__&a=detailChannel&channelid=<?php echo ($vo["id"]); ?>">查看子结点</a>  |  <a target="_self" href="__ADMIN__&a=delChannel&channelid=<?php echo ($vo["id"]); ?>">删除</a></td>
